...
- (struct NSMutableSet { Class x1; }*)_queue_calculateHitTestRegionsFromSceneRects:(struct NSMutableSet { Class x1; }*)arg1;
- (struct NSMutableSet { Class x1; }*)_queue_calculateTouchRegionsFromSceneRects:(struct NSMutableSet { Class x1; }*)arg1;
