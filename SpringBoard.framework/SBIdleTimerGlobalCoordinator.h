...
@interface SBIdleTimerGlobalCoordinator : NSObject <FBSDisplayLayoutObserver, SBIdleTimerCoordinating, SBIdleTimerGlobalStateMonitorObserving, SBIdleTimerObserving> {
