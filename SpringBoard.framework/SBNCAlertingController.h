...
@interface SBNCAlertingController : NSObject <NCAlertingController> {
    ...
    <SBStarkNotificationsAgent> * _carNotificationsAgent;
...
@property (nonatomic) <SBStarkNotificationsAgent> *carNotificationsAgent;
...
- (void)setCarNotificationsAgent:(id)arg1;
