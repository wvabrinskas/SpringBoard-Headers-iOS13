...
@interface SBWidgetController : NSObject <CSWidgetGroupViewControllerProviding, SBExtensionHandling, SBHSidebarWidgetLearningObserver, WGWidgetDiscoveryControllerDelegate> {
...
- (id)sidebarWidgetBootstrappingAdvisor;
