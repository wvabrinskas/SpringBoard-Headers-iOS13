...
@interface SBMainDisplaySceneLayoutDragAndDropInteractionManager : NSObject <BSTransactionObserver, SBApplicationDropSessionSceneProviding, SBDragAndDropAppActivationWorkspaceTransactionDelegate, UIDragInteractionDelegate_ForWebKitOnly, UIDragInteractionDelegate_Private, UIDropInteractionDelegate> {
    NSMapTable * _activeDropSessions;
    SBDragAndDropAppActivationWorkspaceTransaction * _activeTransaction;
    <SBMainDisplaySceneLayoutDragAndDropInteractionManagerDelegate> * _delegate;
...
@property (nonatomic, retain) SBDragAndDropAppActivationWorkspaceTransaction *activeTransaction;
@property (readonly, copy) NSString *debugDescription;
@property (nonatomic, readonly) <SBMainDisplaySceneLayoutDragAndDropInteractionManagerDelegate> *delegate;
@property (readonly, copy) NSString *description;
@property (nonatomic, retain) UIDropInteraction *dropInteraction;
@property (nonatomic, readonly) SBFluidSwitcherViewController *floatingSwitcherContentController;
@property (readonly) unsigned long long hash;
@property (nonatomic, readonly) SBFluidSwitcherViewController *mainSwitcherContentController;
