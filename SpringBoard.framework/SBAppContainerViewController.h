...
@interface SBAppContainerViewController : SBLayoutElementViewController <SBApplicationSceneViewControlling, SBApplicationSceneViewControllingStatusBarDelegate, SBDeviceApplicationSceneStatusBarStateObserver, SBSceneHandleObserver> {
