...
@interface SBNotchedStatusBarProximityBacklightPolicyEnablementCondition : NSObject <BSInvalidatable, SBAppStatusBarAssertionManagerObserver, SBDeviceApplicationSceneHandleObserver, SBMainDisplaySceneManagerObserver, SBUIActiveOrientationObserver, UIStatusBarServerClient> {
